...
def Result():
    ...
    if (i==1):
        ...
        messagebox.showinfo('Projectkumaravell', 'Please Choose one of Encryption or Decrption. Try again.')
...
wn.title("Encrypt and Decrypt your Messages with Projectkumaravel")
...
headingLabel = Label(headingFrame1, text=" Welcome to Encryption and \nDecryption with Projectkumaravel", fg='grey19', font=('Courier',13,'bold'))
